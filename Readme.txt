...
-c [file]  Creates the specified file from the current template and
           file list
...
VDBatch is Copyright 2002-2022 by Eric VanHeest.  It is provided as
freeware with no guarantees of any kind.

If you would like to send comments or bug reports, please mail them to
edv_prj@vanheest.org with an appropriate subject line.
